// 以下文件来自 https://github.com/wong2/weixin-agent-sdk (packages/sdk/src/media/media-download.ts)
...
/**
 * 从单个 MessageItem 下载并解密媒体内容。
 * 成功时返回填充好的 WeixinInboundMediaOpts；类型不支持或失败时返回空对象。
 */
